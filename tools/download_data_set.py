...
def mnist_dataset():
  ...
  ungzip("../tools/train_features.gz", "train_features.ubytes")
  
  ungzip("../tools/train_labels.gz", "train_labels.ubytes")

  ungzip("../tools/test_features.gz", "test_features.ubytes")
  
  ungzip("../tools/test_labels.gz", "test_labels.ubytes")
